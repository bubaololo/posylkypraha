...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            ...
            <div class="row py-3">
                <h2 class="h5 mb-0" style="color:black; "><a href="#"></a> Трек №<strong>{{ $track  }}</strong></h2>
            </div>
            <div class="row py-5">
                <div class="col-lg-8">
                    {{ $customText  }}
                                        ...
                                        <td>
                                            <div class="d-flex mb-2">
                                                <div class="flex-lg-grow-1 ms-3">
                                                    <h6 class="small mb-0"><a href="#" class="text-reset">{{ $item['description'] }}</a></h6>
                                                    <span class="small">Вес: {{ $item['weight_kg'] }} кг {{ $item['weight_g'] }} г</span>
                                                    <span class="small">Количество: {{ $item['quantity'] }} шт.</span>
                                                    <span class="small">Ценность: {{ $item['value'] }} </span>
                                                </div>
                                            </div>
                                        </td>
                                        {{--<td>{{ $item['quantity'] }}</td>--}}
